...
TAKEOVER_EVENT_TYPES = frozenset(
    {
        "TAKEOVER_INITIALIZED", "TAKEOVER_INTAKE_RECORDED", "PROJECT_AUDIT_COMPLETED",
        "HISTORY_RECONSTRUCTED", "PROJECT_CORE_COMPILED", "PROJECT_CORE_APPROVED",
        "ENVIRONMENT_VERIFIED", "BASELINE_SELECTED", "BASELINE_REPRODUCED",
        "BASELINE_RECOVERY_REQUIRED", "BASELINE_APPROVED", "TRIAL_CONTRACT_COMPILED",
        "TRIAL_CONTRACT_APPROVED", "TRIAL_PROPOSED", "TRIAL_CODE_COMPLETED",
        "TRIAL_TEST_COMPLETED", "TRIAL_RUN_COMPLETED", "TRIAL_ANALYSIS_COMPLETED",
        "TRIAL_EXPERT_REVIEW_COMPLETED", "TRIAL_KEPT", "TRIAL_REVERTED",
        "TRIAL_INVESTIGATION_REQUESTED", "BEST_KNOWN_UPDATED", "BATCH_CHECKPOINT_CREATED",
        "USER_DIRECTION_REQUESTED", "USER_CORRECTION_RECORDED", "CONTRACT_AMENDED",
        "TAKEOVER_COMPLETED",
    }
)
