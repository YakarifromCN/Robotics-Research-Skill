...
class TakeoverV3Tests(unittest.TestCase):
    ...
    def test_full_takeover_trial_pause_and_resume(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertTrue(manager.paths.root_report.exists())
            self.assertTrue(manager.paths.root_handoff.exists())
            self.assertIn("trial-0001", manager.paths.root_report.read_text(encoding="utf-8"))
