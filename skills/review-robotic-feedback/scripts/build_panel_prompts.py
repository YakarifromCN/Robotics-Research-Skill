...
def main():
    ...
    result={"schema_version":"robotics-panel-prompts.v1","review_id":context.get("review_id"),"context_sha256":sha256_file(a.context),"target":target,"review_language":language,"review_language_mode":language_mode(language),"review_output_dir":str(review_dir),"reviewers":prompts}
