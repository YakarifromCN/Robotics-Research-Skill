#!/usr/bin/env python3
"""生成八个独立评审代理的带范围提示并初始化运行清单。

Build scoped prompts for eight independent reviewers and initialize a run manifest.
"""
...
REVIEWERS=("manuscript-proofreading","contribution-calibration-review","robotics-contribution-review","control-optimization-review","robot-learning-review","hardware-review","evidence-artifact-audit","venue-compliance-review")
