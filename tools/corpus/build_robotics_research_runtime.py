...
from tools.corpus.validate_public_paper_index import load as load_corpus, validate as validate_corpus  # noqa: E402
...
def build(input_path: str | Path, *, exemplar_count: int = 4) -> dict[str, Any]:
    ...
    result = {
        ...
        "runtime_contract": {
            ...
            "offline_build": "python tools/corpus/build_robotics_research_runtime.py --input <local-corpus>",
            "offline_audit": "python tools/corpus/validate_public_paper_index.py <local-corpus>",
