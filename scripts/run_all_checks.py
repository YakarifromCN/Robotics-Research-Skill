...
commands=[
 ...
 [sys.executable,"-B","-m","unittest","discover","-s",str(ROOT/"skills/robotics-ar/tests"),"-v"],
 [sys.executable,"-B","-m","unittest","discover","-s",str(ROOT/"tests"),"-p","test_local_skill_install.py","-v"],
